...
write_feather(sampleSizes_indiv_python, paste0("../specification_files/option",option,"_fullPop_indivSampleSizes.feather"))
sampleSizes_genomes_R=sampleSizes_indiv*2
saveRDS(sampleSizes_genomes_R,paste0("../specification_files/option",option,"_fullPop_genomeSampleSizes.RDS"))
